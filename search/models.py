...
class Search(models.Model):
    ...
    hashtags_searched = models.ManyToManyField(Hashtag,related_name="in_searches",blank=True)
    channels_searched_flag = models.BooleanField(default=False)
    channels_searched = models.ManyToManyField(Channel,related_name="in_searches",blank=True)
    user_handles_searched_flag = models.BooleanField(default=False)
    user_handles_searched = models.ManyToManyField(User,related_name="in_searches",blank=True)
